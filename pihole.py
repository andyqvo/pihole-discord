...
async def show_stats(channel_id):
    ...
    fields = [
        {"name": "Total Queries", "value": dns_queries_today, "inline": True},
        {"name": "Queries Blocked", "value": ads_blocked_today, "inline": True},
        {"name": "Percentage Blocked", "value": ads_percentage_today, "inline": True},
        {"name": "Domains on Adlists", "value": domains_being_blocked, "inline": True}
    ]
